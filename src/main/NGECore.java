...
public class NGECore {
	...
	public void start() {
		...
		//space sectors
		terrainService.addPlanet(13, "space_tatooine", "terrain/space_tatooine.trn", true);
		terrainService.addPlanet(14, "space_naboo", "terrain/space_naboo.trn", true);
		terrainService.addPlanet(15, "space_corellia", "terrain/space_corellia.trn", true);
		terrainService.addPlanet(17, "space_lok", "terrain/space_lok.trn", true);
		terrainService.addPlanet(18, "space_dantooine", "terrain/space_dantooine.trn", true);
		terrainService.addPlanet(20, "space_yavin4", "terrain/space_yavin4.trn", true);
		terrainService.addPlanet(21, "space_endor", "terrain/space_endor.trn", true);
		terrainService.addPlanet(22, "space_dathomir", "terrain/space_dathomir.trn", true);
		terrainService.addPlanet(23, "space_kashyyyk", "terrain/space_kashyyyk.trn", true);
		//tansarii
		terrainService.addPlanet(24, "ord_mantell",  "terrain/Space_ord_mantell", true);
		//unknowns
		terrainService.addPlanet(25, "NPE", "terrain/space_npe_falcon.trn", true);
		terrainService.addPlanet(26, "NPE2", "terrain/space_npe_falcon_2.trn", true);
		terrainService.addPlanet(27, "NPE3", "terrain/space_npe_falcon_3.trn", true);
		//deepspace
		terrainService.addPlanet(28, "deep_space", "terrain/space_heavy1.trn", true);
		//new new ord mantell
		terrainService.addPlanet(29, "Nova_Orion", "terrain/space_nova_orion.trn", true);
		//missing kessel ?space_light1.trn?
